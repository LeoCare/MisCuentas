package com.app.miscuentas.repository.provider
...
//            HojaCalculo(2, "Hoja 2", LocalDate.now(), 200.0, "FINALIZADA",
//                ParticipantesProvider.listaParti
//            ),
//            HojaCalculo(3, "Hoja 3", LocalDate.now(), 300.0, "FINALIZADA",
//                ParticipantesProvider.listaParti
//            ),
//            HojaCalculo(4, "Hoja 4", null, 400.0, "ACTIVA", ParticipantesProvider.listaParti),
//            HojaCalculo(5, "Hoja 5", LocalDate.now(), 500.0, "FINALIZADA",
//                ParticipantesProvider.listaParti
//            )
//        )
//
