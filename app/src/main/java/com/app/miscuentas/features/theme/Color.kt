...
val md_theme_light_onSecondary = Color(0xFFE0DCDC)
val md_theme_light_secondaryContainer = Color(0xFFCCE8EA)
val md_theme_light_onSecondaryContainer = Color(0xFF449247)
val md_theme_light_tertiary = Color(0xFF4F5F7D)
val md_theme_light_onTertiary = Color(0xFFFFFFFF)
val md_theme_light_tertiaryContainer = Color(0xFFE3EBFD)
val md_theme_light_onTertiaryContainer = Color(0xFF5BA59E)
val md_theme_light_error = Color(0xFFBA1A1A)
val md_theme_light_errorContainer = Color(0xFFFDE9E7)
val md_theme_light_onError = Color(0xFFFFFFFF)
val md_theme_light_onErrorContainer = Color(0xFF410002)
val md_theme_light_background = Color(0xFFE5F0F1)
...
val md_theme_light_surfaceVariant = Color(0xFFCED6D6)
val md_theme_light_onSurfaceVariant = Color(0xFF3F4849)
val md_theme_light_outline = Color(0xFFE3E9EB)
val md_theme_light_inverseOnSurface = Color(0xFFEFF1F1)
val md_theme_light_inverseSurface = Color(0xFFDCEDC8)
val md_theme_light_inversePrimary = Color(0xFFA5D6A7)
val md_theme_light_shadow = Color(0xFF000000)
val md_theme_light_surfaceTint = Color(0xFF9FA8DA)
val md_theme_light_outlineVariant = Color(0xFFDCEDC8)
val md_theme_light_scrim = Color(0xFFE5CDE9)
